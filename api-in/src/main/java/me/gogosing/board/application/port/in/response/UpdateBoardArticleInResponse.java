...
public final class UpdateBoardArticleInResponse {
	...
	private final List<UpdateBoardAttachmentInResponse> attachments;

	public static UpdateBoardArticleInResponse of(
		...
		return Optional.ofNullable(boardDomainEntity)
			.map(source -> UpdateBoardArticleInResponse.builder()
				...
				.attachments(UpdateBoardAttachmentInResponse.of(boardAttachmentDomainEntities))
				.build())
			.orElse(null);
	}
}
