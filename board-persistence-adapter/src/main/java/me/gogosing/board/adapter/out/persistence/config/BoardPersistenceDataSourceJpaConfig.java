...
@EnableJpaRepositories(
	basePackages = {BoardPersistenceDataSourceJpaConfig.BOARD_PERSISTENCE_PACKAGE},
	transactionManagerRef = BoardPersistenceDataSourceJpaConfig.BOARD_PERSISTENCE_TRANSACTION_MANAGER,
	entityManagerFactoryRef = BoardPersistenceDataSourceJpaConfig.BOARD_PERSISTENCE_ENTITY_MANAGER_FACTORY)
public class BoardPersistenceDataSourceJpaConfig {
	...
	public static final String BOARD_PERSISTENCE_PACKAGE = "me.gogosing.board.adapter.out.persistence";
