...
@BoardPersistenceTransactional(readOnly = true, propagation = Propagation.SUPPORTS)
public abstract class BoardPersistenceRepositorySupport extends QuerydslRepositorySupport implements
	InitializingBean {

	public BoardPersistenceRepositorySupport(Class<?> domainClass) {
		super(domainClass);
	}
