...
@FileJpaTransactional(readOnly = true, propagation = Propagation.SUPPORTS)
public abstract class FileJpaRepositorySupport extends QuerydslRepositorySupport implements
	InitializingBean {

	public FileJpaRepositorySupport(final Class<?> domainClass) {
		super(domainClass);
	}
